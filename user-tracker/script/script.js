...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      // info.start and info.end contain the selected date range
      var selectedDate = info.start;
      // You can perform actions here when a date range is selected
      alert('Selected date: ' + selectedDate.toLocaleDateString());
    },
      events: [
        // Here you can add past attendance events dynamically
        {
          title: 'Math - Present',
          start: '2024-04-01'
        },
        {
          title: 'Science - Absent',
          start: '2024-04-05'
        },
        {
