...
<input type="hidden" id="status" value=<%= request.getAttribute("status")%>>
	...
	<script type="text/javascript">
		...
		if(status == "success"){
			...
			swal("Caution","please enter your name !","error");
		}
		else if(status == "invalidEmail"){
			swal("Caution","Plase enter your email id !","error");
		}
		else if(status == "invalidPassword"){
			swal("Warning","Please enter password !","error");
		}
		else if(status == "invalidConfirmPassword"){
			swal("Warning","Password do not match !","error");
		}
		else if(status == "invalidNumber"){
			swal("Caution","Invalid mobile number !","error");
		}
